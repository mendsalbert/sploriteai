...
const PageSignUp: FC<PageSignUpProps> = ({}) => {
  ...
  return (
    ...
    //     <h2 className='my-20 flex items-center justify-center text-3xl font-semibold leading-[115%] text-neutral-900 dark:text-neutral-100 md:text-5xl md:leading-[115%]'>Signup</h2>
